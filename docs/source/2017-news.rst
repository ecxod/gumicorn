...
- The previously deprecated ``gunicorn_django`` command has been removed.
  Use the :ref:`gumicorn-cmd` command-line interface instead.
...
- add environment variables to gumicorn access log format (:issue:`1291`)
...
- `fix leak <https://github.com/ecxod/gumicorn/commit/b4c41481e2d5ef127199a4601417a6819053c3fd>`_ of duplicate file descriptor for bound sockets.
...
- fix: o fds are given by default in gumicorn (:issue:`1423`)
