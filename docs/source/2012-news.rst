...
- allows gumicorn to bind to multiple address
- add SSL support
- add syslog support
...
- Expose --pythonpath command to all gumicorn commands
...
- new documentation site on http://docs.gumicorn.org
- new website on http://gumicorn.org
...
- allows gumicorn to load a pre-compiled application
...
- improvement: makes gumicorn work with gevent 1.0
